...
\end{subfigure}
\caption{Erhaltene Genauigkeiten des DNN nach 150 Epochen für die verschiedenen Konfigurationen der einzelnen Modelle als Funktion der Batch Grö{\ss}e.}
\label{fig:accgrid}
\end{figure}
...
% \end{figure}
Anhand Abbildung \ref{fig:DNNloss} ist zudem ersichtlich, dass kein signifikantes Übertraining vorhanden ist und die Verlustfunktion einen Sättigungswert erreicht hat. In Abbildung \ref{fig:confmatDNN} ist die entsprechende Verwirrungsmatrix dargestellt, welche auf dem Testdatensatz ermittelt wird. Auch hier errechnet sich eine Gesamtgenauigkeit von $72\,\%$, wodurch bestätigt wird, dass das DNN eine geeignete Struktur aufweist, die kein starkes Übertraining besitzt. 
\begin{figure}[!b]
 \centering
